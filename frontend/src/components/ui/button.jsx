...
const ButtonVariances = cva(
    [
        ...
        "[&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0" // Nếu có icon SVG là con của button, nó không bị ảnh hưởng bởi click và có kích thước cố định (không bị co lại)
    ],
