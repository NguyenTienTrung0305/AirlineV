...
export default function Footer() {
  return (
    <footer className="bg-[url(/bg-map-2.png)] bg-[#313041] py-16 bg-contain ">
      <div className="text-[#A9A8B6] flex lg:flex-nowrap flex-wrap lg:justify-between justify-start max-w-[1200px] xl:px-0 px-6 mx-auto gap-10">
        ...
        {/* khi thằng con áp dụng flex, nó sẽ tuân theo quy tắc mới, không còn áp dụng flex của thằng cha */}
        <div className="flex lg:w-2/5 gap-10">
          {/* About company */}
